        ...
        <div class="card w-100">
          <div class="card-header row">
            <div class="d-flex justify-content-end align-items-center w-100">
              <button class="btn {{ $in_status != 0 ? 'btn-success' : 'btn-danger' }}" type="button" data-toggle="modal"
                {{ $in_status != 0 ? 'data-target="#TambahData"' : 'data-target="alert"' }} id="modal-button"><i
                  class="fas fa-plus m-1"></i> {{ __('add data') }}</button>
            </div>
          </div>
                  ...
                  <div class="row">
                    <div class="col-md-7">
                      <div class="form-group">
                        <label for="kode" class="form-label">{{ __('outgoing item code') }}<span
                      ...
                      <div class="form-group">
                        <label for="tanggal_keluar" class="form-label">{{ __('out date') }} <span
                            class="text-danger">*</span></label>
                        <input type="date" name="tanggal_keluar" class="form-control">
                      </div>
                      <div class="form-group">
                        <label for="customer" class="form-label">{{ __('choose customers') }}<span
                            class="text-danger">*</span></label>
                    ...
                    <div class="col-md-5">
                      ...
                      <div class="input-group">
                        ...
                        <div class="input-group-append">
                          <button class="btn btn-outline-primary" type="button" id="cari-barang"><i
