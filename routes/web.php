...
Route::middleware(['auth', "localization"])->group(function () {
  ...
  Route::middleware(['employee.middleware'])->group(function () {
    ...
    // Tambahkan route untuk role
    Route::controller(RoleController::class)->prefix('/settings/role')->group(function () {
      Route::post('/save', 'save')->name('settings.role.save');
      Route::post('/detail', 'detail')->name('settings.role.detail');
      Route::put('/update', 'update')->name('settings.role.update');
      Route::delete('/delete', 'delete')->name('settings.role.delete');
    });
  });
